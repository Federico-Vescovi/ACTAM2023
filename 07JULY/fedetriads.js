...
function practiceMode(){
    ...
    if(skipMetronome)practiceMetronome();
return;
}
            ...
            switch (parseInt(selectedTriad)) {
                case 0:
                    ...
                    for(var i=0; i<3; i++){
                        ...
                        if (note_position[i]){
                            //alert ("5th:" +fifthToShift)
                            //alert ("note_pos:" +note_position)
                            const stringIndex = note_position[i][0];
                            //alert ("stringIndex:"+stringIndex);
                            var fretIndex = note_position[i][1];
                            //alert ("fretIndex:"+fretIndex);
                            
                            if(fifthToShift.includes(stringIndex)){
                                fretIndex=(fretIndex-1+12)%12;
                                var dotValues = [values[2]];
                                //notaattuale=2 (corrisponde alla quinta)
                            }
                            ...
                            app.addDot(stringIndex, fretIndex, dotValues); //app.addDot(stringIndex, fretIndex, notaattuale);
                        }
                    }
                break;
                case 1:
                    ...
                    for(var i=0; i<3; i++){
                        ...
                        if (note_position[i]){
                            ...
                            if(thirdToShift.includes(stringIndex)){fretIndex=(fretIndex-1+12)%12; var dotValues = [values[1]];}
                            else if(fifthToShift.includes(stringIndex)){fretIndex=(fretIndex-1+12)%12; var dotValues = [values[2]];}
                            else {var dotValues = [values[0]];}
                            app.addDot(stringIndex, fretIndex, dotValues);
                        }
                    }
                break;
                case 2:
                ...
                case 3:   
                    ...
                    for(var i=0; i<3; i++){
                        ...
                        if (note_position[i]){
                            ...
                            if(thirdToShift.includes(stringIndex)){fretIndex=(fretIndex-1+12)%12; var dotValues = [values[1]]}
                            else if(fifthToShift.includes(stringIndex)){fretIndex=(fretIndex-2+12)%12; var dotValues = [values[2]]}
                            else{var dotValues = [values[0]]};
                            app.addDot(stringIndex, fretIndex, dotValues);
                        }
                    }
