...
function practiceMode(){
    ...
    document.getElementById("reproducePractice").style.display="inline-block";
return;
}



var reproducingPractice=0;

async function generateSoundPractice(){
    if(reproducingPractice||(mode!=1)||(rootNote=="noRootGenerated"))return;
    reproducingPractice=1;
    
    
    if(reproducingPractice==0){
        reproducingPractice=1;
        document.getElementById("playIcon").style.visibility="hidden";
        document.getElementById("stopIcon").style.visibility="visible";}
    else {reproducingPractice=0;
    ...
    //4 metronome ticks
    if(mode==0) {reproducingPractice=0; return;}
...
async function playAlongMode(){
    ...
    document.getElementById("reproducePractice").style.display="none";
