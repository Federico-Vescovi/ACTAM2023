...
async function generateSoundPractice(){
    ...
    //4 metronome ticks
    beatCount=0;
    if(mode==0||reproducingPractice==0) {reproducingPractice=0; return;}
...
function toggleFretboard() {
    ...
    if (fretboard.classList.contains('fretboard-visible')) {
      ...
      btnIcons.forEach((btnIcon) => {
        ...
        //btnIcon.style.top = '57.5vh';
        //255: fretboard height
   ...
   // Adjust the position of specific buttons when fretboard is hidden
    ...
    document.getElementById("toggleFretboardButton").style.bottom = '0vh';
    document.getElementById("toggleFretboardButton").style.left = '91vw';
